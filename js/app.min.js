(() => {
  ...
  const d = document.querySelectorAll(".pl-func"),
    h = document.querySelectorAll(".pr-func");
  let u;
  function m() {
    (u = window.innerWidth < 1630 ? 15 : (window.innerWidth - 1600) / 2),
      d.length &&
        d.forEach((t) => {
          t.style.paddingLeft = u + "px";
        }),
      h.length &&
        h.forEach((t) => {
          t.style.paddingRight = u + "px";
        });
  }
  async function g() {
    try {
      const t = "0x27bbb7e6d8b8b9a4c36e67c5d7ce7fa8d51628e1";
        ...
        if ("click" === e.type) {
          ...
          if (o.closest("[data-goto]")) {
            const a = o.closest("[data-goto]"),
              ...
              i = a.dataset.gotoSpeed ? a.dataset.gotoSpeed : 500,
